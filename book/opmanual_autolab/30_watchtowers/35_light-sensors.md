...
Requires: A fully operational [Duckietown](+opmanual_duckietown#book) with [watchtowers](#watchtower-hardware) built to
 right specs. TODO : add the name of the right specs
